'''
comtweet is copyright (c)2010 andrewsteinborn

this is public domain. have a nice day.
'''
...
# Make sure to change this if setting up another instance of comtweet. These keys point to the official comtweet app

OAUTH_APP_SETTINGS = {

    'twitter': {

        'consumer_key': '7ZTpLoK3lnrxvpmchtYDA',
        'consumer_secret': 'V9lsU7ru4CFE0KCZ2CVHtgQ1sZg7hdroOAf3yO1KbE',
